...
-- Setting a single space to to nothing since space is my leader key
...
--
--  See `:help wincmd` for a list of all window commands_created
--  I am handling these on my own
